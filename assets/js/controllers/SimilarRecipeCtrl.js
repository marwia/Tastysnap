/**
 * assets/js/controllers/SimilarRecipeCtrl.js
 *
 * Mariusz Wiazowski
 *
 * Controller per gestire le ricette simili a quella visualizzata appena 
 * dall'utente.
 */
angular.module('SimilarRecipeCtrl', []).controller('SimilarRecipeCtrl', [
    '$scope',
    'Recipe',
    'Auth',
    'Collection',
