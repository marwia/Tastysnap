...
var mailOptions = {
    ...
    subject: 'Add Ingredient Request', // Subject line
...
module.exports = {
    ...
    */
    ...
    /**
    * @api {post} /ingredient/add_request Send request to add ingredient
    * @apiName addIngredientReq
    * @apiGroup Ingredient
    *
    * @apiDescription Serve per richiedere l'aggiunta di un ingrediente mancante
    * da parte degli amministratori della piattaforma.
    * 
    *
    */
